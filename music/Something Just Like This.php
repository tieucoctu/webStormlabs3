...
<head>
    <meta charset="UTF-8">
    <title>Something Just Like This</title>
...
<section class="content">
    <div class="container">
        <h2 id="id">Something Just Like This</h2>
        <img src="../img/banner.png" id="banner">
        <audio controls autoplay>
            <source src="../audio/Something-Just-Like-This-SlimV-Remix-Coldplay-The-Chainsmokers.mp3">
        </audio>
        <h4>Singer: Coldplay, The Chainsmokers</h4>
        <p>I've been reading books of old</br>
            ...
            And clearly</br>
            I don't see myself upon that list</br>
            ...
            But I'm not the kind</br>
            Of person that it fits</br>
            She said "Where'd you wanna go?</br>
            How much you wanna risk?</br>
            I'm not looking for somebody</br>
            With some superhuman gifts</br>
